namespace DI
{
    ...
    public class AutoPopulateSourceCodeAttribute : FilterAttribute, IResultFilter
    {
        ...
        private const string LayoutExamplesPagePath = ViewPath + "Shared/_Layout.cshtml";
        ...
        public void OnResultExecuting(ResultExecutingContext filterContext)
        {
            ...
            if (viewResult != null)
            {
                ...
                string exampleControllerPath = ControllerPath + controllerName + "Controller.cs";
        ...
        private void RegisterLayoutPages(ResultExecutingContext filterContext, Dictionary<string, string> codeFiles)
        {
            ...
            codeFiles["_Layout.cshtml"] = LayoutExamplesPagePath;
