    ...
    public static class UserDtl
    {
        ...
        public static string CreateDepartmentMaster(string postHindiName, string postEnglishName, int departmenttype, int parentDepartment, int departId, int isShashan, int isMandal, int isDistrict, int isTehsil, int isThana, int isBlock)
        {
            ...
            try
            {
                ...
                Sqlcmd.Parameters.Add("@departHindiName", postHindiName);
                Sqlcmd.Parameters.Add("@departEnglishName", postEnglishName);
                Sqlcmd.Parameters.Add("@departmenttype", departmenttype);
                Sqlcmd.Parameters.Add("@parentDepartment", parentDepartment);
                Sqlcmd.Parameters.Add("@departId", departId);
                Sqlcmd.Parameters.Add("@isShashan", isShashan);
                Sqlcmd.Parameters.Add("@isMandal", isMandal);
                Sqlcmd.Parameters.Add("@isDistrict", isDistrict);
                Sqlcmd.Parameters.Add("@isTehsil", isTehsil);
                Sqlcmd.Parameters.Add("@isThana", isThana);
                Sqlcmd.Parameters.Add("@isBlock", isBlock);
                result = (string)Sqlcmd.ExecuteScalar();
                Sqlcon.Close();
                return result;
            }
        ...
        public static string SaveDioFeedback(int UserId, string Comments, string ContentType, int size, Byte[] bytes)
        {
            ...
            try
            {
                ...
                Sqlcmd.Parameters.Add("@contentType", ContentType);
                Sqlcmd.Parameters.Add("@size", size);
                Sqlcmd.Parameters.Add("@Data", bytes);
                result = (string)Sqlcmd.ExecuteScalar();
                con.Close();
                return result;
            }
        ...
        internal static DataSet Get_RandomCode_Details(int p1, int p2)
        {
            ...
            try
            {
                ...
                Sqlcmd.Parameters.Add("@dist", p1);
                Sqlcmd.Parameters.Add("@dep", p2);
                //Sqlcmd.Parameters.Add("@office_code", office_code);
                Sqlcmd.CommandType = CommandType.StoredProcedure;
                Sqlcmd.CommandTimeout = 600;
